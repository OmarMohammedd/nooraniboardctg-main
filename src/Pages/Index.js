...
const testimonialItems = [
  ...
  const SampleNextArroww = (props) => {
    const { onClick } = props;
    return (
      <ul className="flex-direction-nav" onClick={onClick} style={{marginTop:"-2.4rem"}}>
        <li>
          <Link className="flex-next" to="#" style={{ color: "gray" }}>
            Next
          </Link>
    ...
    <div className="col-md-5">
      <div className="card chairman_card shadow-sm">
        <h5 className="card-header custom_header">
          <i className="fas fa-calendar-alt" /> মুয়াল্লিম প্রশিক্ষণ সময়সূচি
        </h5>
...
>
  <i className="fas fa-download" /> ডাউনলোড করুন
</a>
    ...
    >
      <div className="card border-0" style={{ background: "transparent" }}>
        <h5 className="card-header custom_header">
          <i className="fas fa-calendar-alt" /> প্রশিক্ষণের বাৎসরিক ক্যালেন্ডার
        </h5>
        <div className="card-body p-0 d-inline-block">
          <object
            className="mb-3"
              ...
              <div className="content">
                ...
                <div className="details">
                  <a href="https://www.nooraniboardctg.com/permanent-training-center">
                    <span className="name">স্থায়ী প্রশিক্ষণ কেন্দ্র</span>
