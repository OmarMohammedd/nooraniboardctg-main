...
function AdmissionRegistrationn() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
...
<div className='container'>
  ...
  <div className="row" style={{ textAlign: "center" }}>
    ...
    >
      <a href="https://tmm.edu.bd/admission/">
  ...
  <div className="frm-head grp-head" style={{ maxWidth: 990, margin: "auto" }}>
    <p className="pageHead">
      ভর্তিচ্ছু নতুন শিক্ষার্থী : <span style={{color:"#E80000"}}>ফরম - ২</span>
      <br />
      <span style={{ fontSize: 16 }}>
        নিচের ফরমটি যথাযথভাবে পূরন করে "Submit" করুন । (
        <span style={{color:"#E80000"}}>&nbsp;*&nbsp;</span>)চিহ্নিত ঘর অবশ্যই পুরণ করতে
        হবে
      </span>
    </p>
    <form
    ...
    >
      ...
      <div
        ...
        <div className="pull-left">
          ...
          <div className="frm-ele">
            <label>
              ক্লাশ নির্বাচন করুন :<span style={{color:"#E80000"}}>&nbsp;*</span>
            </label>
            <br />
            <select
              name="class"
            ...
            >
              ...
              <option value={35}>নবম</option>
              <option value={15}>আলিম(সাধারণ)১মবর্ষ</option>
              <option value={16}>আলিম(বিজ্ঞান)১মবর্ষ</option>
              <option value={19}>ফাজিল(১মবর্ষ)</option>
              <option value={31}>কামিল(হাদীস)১মবর্ষ</option>
            </select>
          ...
          <div className="frm-ele">
            <label>
              পিতার নাম ( In English ):<span style={{color:"#E80000"}}>&nbsp;*</span>
            </label>
            <br />
            <input
              name="f_name"
          ...
          <div className="frm-ele">
            <label>
              পিতার NID/Passport নাম্বার:<span style={{color:"#E80000"}}>&nbsp;*</span>
            </label>
            <br />
          ...
          <div className="frm-ele">
            <label>
              মাতার নাম ( In English ) :<span style={{color:"#E80000"}}>&nbsp;*</span>
            </label>
            <br />
            <input
              name="m_name"
          ...
          <div className="frm-ele">
            <label>
              মাতার NID/Passport নাম্বার :<span style={{color:"#E80000"}}>&nbsp;*</span>
            </label>
            <br />
      ...
      <div className="grp-head">
        ...
        <div className="frm-ele">
          <label style={{ paddingLeft: 5 }}>
            জন্ম তারিখ ({" "}
            <span style={{color:"#E80000"}}>জে.ডি.সি পরীক্ষা অনুসারে </span>):
          </label>
        </div>
      ...
      <div className="frm-ele">
        <label className="frm-label">
          বর্তমান ঠিকানা ( In English ):<span style={{color:"#E80000"}}>&nbsp;*</span>
        </label>
        <br />
        <input
          name="pre_address"
    ...
    <input name="L_gname" style="width:410px" type="text" class="form-control" />
      ...
      <div className="frm-ele">
        <label className="frm-label">
          জরুরী যোগাযোগের মোবাইল নাম্বার:<span style={{color:"#E80000"}}>&nbsp;*</span>
        </label>
        <br />
        <input
          maxLength={11}
      ...
      <div className="grp-head table-responsive">
        <div className="frm-ele">
          <label className="frm-label required" style={{ paddingLeft: 5 }}>
        ...
        <div className="grp-div table-responsive">
          ...
          <div className="frm-ele">
            <label className="frm-label">
              EIIN : <span style={{color:"#E80000"}}>&nbsp;*</span>
            </label>
            <br />
            <input name="pre_code" type="text" className="form-control" />
            <div id="ERRpre_code" className="ERR" />
          </div>
          <div className="clearfix" />
          <div className="frm-ele">
          ...
          <div className="frm-ele">
            ...
            <br />
            <input name="n_release" type="text" className="form-control" />
          </div>
        </div>
      </div>
      <div id="preRes" />
      ...
      <label className="frm-label">
        ওয়াদানামা : আমি এই মর্মে ওয়াদা করছি যে,
      </label>
      <br />
      <div
        style={{
      ...
      >
        <table style={{ border: "0px solid black", width: "100%" }}>
          <tbody>
            <tr>
              <td style={{ padding: 0, verticalAlign: "top", fontSize: 14 }}>
                ক.
              </td>
              <td style={{ padding: 0, fontSize: 14 }}>
                আমি ভালভাবে বুঝে শুনেই প্রতিষ্ঠানে ভর্তি হতে চাই, ভর্তি হওয়ার পর
                কোন অবস্থাতেই প্রতিষ্ঠান পরিবরতন করে অন্য কোন প্রতিষ্ঠানে ভর্তির
                জন্য আবেদন করব না।
              </td>
            </tr>
            <tr>
              ...
              <td style={{ padding: 0, fontSize: 14 }}>
                প্রতিষ্ঠানের যাবতীয় নিয়ম শৃঙ্খলা মেনে চলব।
              </td>
            </tr>
            <tr>
              <td style={{ padding: 0, verticalAlign: "top", fontSize: 14 }}>
              ...
              <td style={{ padding: 0, fontSize: 14 }}>
                সংগত কারণ ব্যতীত প্রতিষ্ঠান হতে অনুপস্থিত থাকব না।
              </td>
            </tr>
            <tr>
              <td style={{ padding: 0, verticalAlign: "top", fontSize: 14 }}>
              ...
              <td style={{ padding: 0, fontSize: 14 }}>
                প্রতিষ্ঠানের যাবতীয় প্রাপ্য নির্ধারিত সময়ের মধ্যে পরিশোধ করব।
              </td>
            </tr>
            <tr>
              <td style={{ padding: 0, verticalAlign: "top", fontSize: 14 }}>
              ...
              <td style={{ padding: 0, fontSize: 14 }}>
                প্রতিষ্ঠানের নিয়ম-শৃঙ্খলা বিরোধী কোন কার্যকলাপে লিপ্ত হলে আমার
                ব্যাপারে কর্তৃপক্ষের সিদ্ধান্তই চূড়ান্ত বলে মেনে নেব।
              </td>
            </tr>
            <tr>
              <td style={{ padding: 0, verticalAlign: "top", fontSize: 14 }}>
      ...
      <label>
        {" "}
        ( <span id="num1">8</span> + <span id="num2">6</span> = ? )
      </label>
      <br />
      <div>
        <input
...
export default AdmissionRegistrationn