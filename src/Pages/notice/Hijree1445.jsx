              ...
              <div className="pb-3 card event_card event_card_details">
                ...
                <Link to="#">
                  <img
                    ...
                    src="../public/storage/notice/hijree-1445-sner-ple-narsaree-prthm-oo-dwiteey-srenir-preekshar-rutin.jpg"
                    alt="Card image cap"
                  />
                </Link>
                <br />
                <Link
                  to="../public/storage/notice/hijree-1445-sner-ple-narsaree-prthm-oo-dwiteey-srenir-preekshar-rutin.jpg"
                  download="হিজরী ১৪৪৫ সনের -প্লে-নার্সারী, প্রথম ও দ্বিতীয় শ্রেণির পরীক্ষার রুটিন"
