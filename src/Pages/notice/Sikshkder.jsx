              ...
              <div className="pb-3 card event_card event_card_details">
                ...
                <Link to="#">
                  <img
                    ...
                    src="../public/storage/notice/sikshkder-prti-jruree-hedayat-nama.jpg"
                    alt="Card image cap"
                  />
                </Link>
                <br />
                <Link
                  to="../public/storage/notice/sikshkder-prti-jruree-hedayat-nama.jpg"
                  download="শিক্ষকদের প্রতি জরুরী হেদায়াত নামা"
