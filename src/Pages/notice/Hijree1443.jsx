              ...
              <div className="pb-3 card event_card event_card_details">
                ...
                <div className="card-body p-4 mt-4">
                  ...
                  <p>
                    ...
                    <font face="Poppins, sans-serif">
                      কর্তৃক আয়োজিত ১৪৪৫ হিজরী পরীক্ষার ফি সংক্রান্ত বিষয়ে জরুরি
                      বিজ্ঞপ্তি
                    </font>
                    <br />
                  </p>
                ...
                <Link to="#">
                  <img
                    ...
                    src="../public/storage/notice/1445-hijree-preekshar-fi-sngkrant.jpg"
                    alt="Card image cap"
                  />
                </Link>
                <br />
                <Link
                  to="../public/storage/notice/1445-hijree-preekshar-fi-sngkrant.jpg"
                  download="১৪৪৫ হিজরী পরীক্ষার ফি সংক্রান্ত"
